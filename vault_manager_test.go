...
func (m *mockFailingListStore) LoadSalt() ([]byte, error) {
	return nil, fmt.Errorf("mock load salt failure")
}

func (m *mockFailingListStore) SaveSalt(salt []byte) error {
	return fmt.Errorf("mock save salt failure")
}

func (m *mockFailingListStore) LoadMetadata() ([]byte, error) {
	return nil, fmt.Errorf("mock load metadata failure")
}

func (m *mockFailingListStore) SaveMetadata(metadata []byte) error {
