...
//	PassphraseAccesses: Count of passphrase-related operations
//	SecretAccesses:     Count of secret retrieval and manipulation operations
...
type AuditSummary struct {
	...
	PassphraseAccesses int       `json:"passphrase_accesses"`
	SecretAccesses     int       `json:"secret_accesses"`
