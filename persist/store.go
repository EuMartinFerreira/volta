...
type Store interface {
	...
	// SaveMetadata stores the provided encrypted metadata in the vault.
	// Parameters:
	// - encryptedMetadata: A byte slice containing the encrypted metadata.
	// Returns:
	// - An error if the operation fails.
	SaveMetadata(encryptedMetadata []byte) error
	...
	// SaveSalt stores the provided salt data in the vault.
	// Parameters:
	// - saltData: A byte slice containing the salt data.
	// Returns:
	// - An error if the operation fails.
	SaveSalt(saltData []byte) error
	...
	// SaveSecretsData stores the provided encrypted secrets data in the vault.
	// Parameters:
	// - encryptedSecretsData: A byte slice containing the encrypted secrets data.
	// Returns:
	// - An error if the operation fails.
	SaveSecretsData(encryptedSecretsData []byte) error

	// LoadSecretsData retrieves the encrypted secrets data from the vault.
	// Returns:
	// - A byte slice containing the encrypted secrets data.
	// - An error if the operation fails or if no secrets data exists.
	LoadSecretsData() ([]byte, error)
...
type StoreConfig struct {
	...
	// For example, when using StoreTypeS3, this may include keys like "bucket" and "region".
...
const (
	...
	// Configuration related to S3, such as bucket name and credentials, will be provided in the Config field.
